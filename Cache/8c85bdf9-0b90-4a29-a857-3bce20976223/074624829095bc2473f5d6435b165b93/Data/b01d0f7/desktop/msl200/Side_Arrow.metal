...
//float4 Port_Input0_N102 4528
//float Port_Import_N092 4560
//float4 Port_Input1_N094 4576
//float Port_Import_N095 4592
//float Port_Import_N100 4596
//float Port_RangeMinA_N079 4600
//float Port_RangeMaxA_N079 4604
//float Port_RangeMinB_N079 4608
//float Port_RangeMaxB_N079 4612
//float4 Port_Value0_N080 4624
//float Port_Position1_N080 4640
//float4 Port_Value1_N080 4656
//float Port_Position2_N080 4672
//float4 Port_Value2_N080 4688
//float Port_Position3_N080 4704
//float4 Port_Value3_N080 4720
//float Port_Position4_N080 4736
//float4 Port_Value4_N080 4752
//float4 Port_Value5_N080 4768
//float Port_Input1_N081 4784
//float depthRef 4788
//}
...
float param_13=ValueOut_N79;
float4 param_14=(*sc_set0.UserUniforms).Port_Value0_N080;
float param_15=(*sc_set0.UserUniforms).Port_Position1_N080;
float4 param_16=(*sc_set0.UserUniforms).Port_Value1_N080;
float param_17=(*sc_set0.UserUniforms).Port_Position2_N080;
float4 param_18=(*sc_set0.UserUniforms).Port_Value2_N080;
float param_19=(*sc_set0.UserUniforms).Port_Position3_N080;
float4 param_20=(*sc_set0.UserUniforms).Port_Value3_N080;
float param_21=(*sc_set0.UserUniforms).Port_Position4_N080;
float4 param_22=(*sc_set0.UserUniforms).Port_Value4_N080;
float4 param_23=(*sc_set0.UserUniforms).Port_Value5_N080;
param_13=fast::clamp(param_13,0.0,1.0);
float4 param_24;
if (param_13<param_15)
{
param_24=mix(param_14,param_16,float4(fast::clamp(param_13/param_15,0.0,1.0)));
}
else
{
if (param_13<param_17)
{
param_24=mix(param_16,param_18,float4(fast::clamp((param_13-param_15)/(param_17-param_15),0.0,1.0)));
}
else
{
if (param_13<param_19)
{
param_24=mix(param_18,param_20,float4(fast::clamp((param_13-param_17)/(param_19-param_17),0.0,1.0)));
}
else
{
if (param_13<param_21)
{
param_24=mix(param_20,param_22,float4(fast::clamp((param_13-param_19)/(param_21-param_19),0.0,1.0)));
}
else
{
param_24=mix(param_22,param_23,float4(fast::clamp((param_13-param_21)/(1.0-param_21),0.0,1.0)));
}
}
}
}
...
Output_N82=Output_N7*Output_N81;
...
float4 l9_89=fast::max(param_26,float4(0.0));
float4 param_27=l9_89;
if (sc_ShaderCacheConstant_tmp!=0)
{
