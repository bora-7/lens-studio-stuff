...
//float4 Tweak_N0 4400
//float Opacity 4416
//float3 Port_Normal_N002 4432
//float Port_Exponent_N002 4448
//float Port_Intensity_N002 4452
//float depthRef 4456
//}
...
float l9_1=abs(dot(-param_6.ViewDirWS,param_2));
float param_5=pow(1.0-l9_1,param_3);
param_5=fast::max(param_5,0.0);
param_5*=param_4;
Rim_N2=param_5;
float Output_N9=0.0;
Output_N9=1.0-Rim_N2;
float4 Output_N8=float4(0.0);
Output_N8=Output_N1*float4(Output_N9);
float4 Output_N0=float4(0.0);
float4 param_7=(*sc_set0.UserUniforms).Tweak_N0;
Output_N0=param_7;
float4 Output_N5=float4(0.0);
Output_N5=Output_N0*float4(Rim_N2);
float4 Output_N3=float4(0.0);
Output_N3=Output_N8+Output_N5;
float Output_N10=0.0;
float param_8=(*sc_set0.UserUniforms).Opacity;
Output_N10=param_8;
float4 Output1_N11=float4(0.0);
Output1_N11=float4(Output_N3.xyz,Output_N10);
...
float4 l9_5=fast::max(param_10,float4(0.0));
float4 param_11=l9_5;
if (sc_ShaderCacheConstant_tmp!=0)
{
