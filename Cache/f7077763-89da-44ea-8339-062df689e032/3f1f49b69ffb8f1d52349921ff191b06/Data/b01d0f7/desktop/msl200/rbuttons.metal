...
//sampler sampler textSmpSC 0:34
...
//texture texture2D text 0:22:0:34
...
//float hover 4528
//float3x3 textTransform 4592
//float4 textUvMinMax 4640
//float4 textBorderColor 4656
//float2 textUVScale 4672
//float globalOpacity 4680
//float Port_RangeMinA_N016 4684
//float Port_RangeMaxA_N016 4688
//float Port_RangeMinB_N016 4692
//float Port_RangeMaxB_N016 4696
//float2 Port_Center_N014 4704
//float Port_RangeMinA_N017 4712
//float Port_RangeMaxA_N017 4716
//float Port_RangeMinB_N017 4720
//float Port_RangeMaxB_N017 4724
//float2 Port_Center_N009 4752
//float Port_Input1_N013 4784
//float Port_Input2_N013 4788
//float depthRef 4792
//}
...
//spec_const int textLayout 90 0
//SG_REFLECTION_END
...
constant bool SC_USE_CLAMP_TO_BORDER_text [[function_constant(33)]];
constant bool SC_USE_CLAMP_TO_BORDER_text_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_text) ? SC_USE_CLAMP_TO_BORDER_text : false;
...
constant bool SC_USE_UV_MIN_MAX_text [[function_constant(36)]];
constant bool SC_USE_UV_MIN_MAX_text_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_text) ? SC_USE_UV_MIN_MAX_text : false;
...
constant bool SC_USE_UV_TRANSFORM_text [[function_constant(39)]];
constant bool SC_USE_UV_TRANSFORM_text_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_text) ? SC_USE_UV_TRANSFORM_text : false;
...
constant bool textHasSwappedViews [[function_constant(74)]];
constant bool textHasSwappedViews_tmp = is_function_constant_defined(textHasSwappedViews) ? textHasSwappedViews : false;
...
constant int SC_SOFTWARE_WRAP_MODE_U_text [[function_constant(77)]];
constant int SC_SOFTWARE_WRAP_MODE_U_text_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_text) ? SC_SOFTWARE_WRAP_MODE_U_text : -1;
...
constant int SC_SOFTWARE_WRAP_MODE_V_text [[function_constant(80)]];
constant int SC_SOFTWARE_WRAP_MODE_V_text_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_text) ? SC_SOFTWARE_WRAP_MODE_V_text : -1;
...
constant int textLayout [[function_constant(90)]];
constant int textLayout_tmp = is_function_constant_defined(textLayout) ? textLayout : 0;
...
float4 textDims;
float4 textView;
float3x3 textTransform;
float4 textUvMinMax;
float4 textBorderColor;
float2 textUVScale;
float globalOpacity;
...
texture2d<float> text [[id(22)]];
sampler baseTexSmpSC [[id(23)]];
sampler intensityTextureSmpSC [[id(24)]];
sampler sc_RayTracingHitCasterIdAndBarycentricSmpSC [[id(28)]];
sampler sc_RayTracingRayDirectionSmpSC [[id(29)]];
sampler sc_ScreenTextureSmpSC [[id(31)]];
sampler textSmpSC [[id(34)]];
...
float2 param_14=(*sc_set0.UserUniforms).textUVScale;
Output_N10=param_14;
float2 CoordsOut_N9=float2(0.0);
CoordsOut_N9=((CoordsOut_N14-(*sc_set0.UserUniforms).Port_Center_N009)*Output_N10)+(*sc_set0.UserUniforms).Port_Center_N009;
float4 Output_N23=float4(0.0);
int l9_76;
if ((int(textHasSwappedViews_tmp)!=0))
{
int l9_77=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_81=l9_76;
int param_15=textLayout_tmp;
int param_16=l9_81;
float2 param_17=CoordsOut_N9;
bool param_18=(int(SC_USE_UV_TRANSFORM_text_tmp)!=0);
float3x3 param_19=(*sc_set0.UserUniforms).textTransform;
int2 param_20=int2(SC_SOFTWARE_WRAP_MODE_U_text_tmp,SC_SOFTWARE_WRAP_MODE_V_text_tmp);
bool param_21=(int(SC_USE_UV_MIN_MAX_text_tmp)!=0);
float4 param_22=(*sc_set0.UserUniforms).textUvMinMax;
bool param_23=(int(SC_USE_CLAMP_TO_BORDER_text_tmp)!=0);
float4 param_24=(*sc_set0.UserUniforms).textBorderColor;
float param_25=0.0;
...
float4 l9_148=sc_set0.text.sample(sc_set0.textSmpSC,l9_147.xy,bias(l9_141));
...
float param_26=(*sc_set0.UserUniforms).globalOpacity;
Output_N20=param_26;
...
float4 l9_154=fast::max(param_28,float4(0.0));
float4 param_29=l9_154;
if (sc_ShaderCacheConstant_tmp!=0)
{
