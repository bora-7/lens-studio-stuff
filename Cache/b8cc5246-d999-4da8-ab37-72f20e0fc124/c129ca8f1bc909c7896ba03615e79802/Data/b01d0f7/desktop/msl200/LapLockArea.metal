...
//}
//ubo int UserUniforms 0:31:4736 {
//float4 sc_Time 1376
...
//float4 Tweak_N15 4384
//float Tweak_N12 4400
//float GlobalOpacity 4404
//float2 Port_Input1_N006 4408
//float Port_Input1_N008 4416
//float Port_Input1_N011 4420
//float4 Port_Value0_N010 4432
//float Port_Position1_N010 4448
//float4 Port_Value1_N010 4464
//float4 Port_Value2_N010 4480
//float Port_Input1_N013 4496
//float4 Port_Value3_N010 4512
//float4 Port_Value4_N010 4528
//float4 Port_Value0_N000 4544
//float Port_Position1_N000 4560
//float4 Port_Value1_N000 4576
//float Port_Position2_N000 4592
//float4 Port_Value2_N000 4608
//float Port_Position3_N000 4624
//float4 Port_Value3_N000 4640
//float4 Port_Value4_N000 4656
//float Port_Input1_N001 4672
//float4 Port_Input1_N003 4688
//float4 Port_Input2_N003 4704
//float depthRef 4720
//}
...
float4 Port_Value3_N010;
float4 Port_Value4_N010;
...
float Port_Input1_N001;
float4 Port_Input1_N003;
float4 Port_Input2_N003;
float depthRef;
};
struct sc_Bone_t
{
...
float4 param_1=(*sc_set0.UserUniforms).Tweak_N15;
Output_N15=param_1;
float2 UVCoord_N2=float2(0.0);
UVCoord_N2=Globals.Surface_UVCoord0;
float Output_N6=0.0;
Output_N6=distance(UVCoord_N2,(*sc_set0.UserUniforms).Port_Input1_N006);
float Output_N8=0.0;
Output_N8=Output_N6*(*sc_set0.UserUniforms).Port_Input1_N008;
float Output_N9=0.0;
Output_N9=1.0-Output_N8;
float Output_N11=0.0;
Output_N11=Output_N9-(*sc_set0.UserUniforms).Port_Input1_N011;
float Output_N12=0.0;
float param_2=(*sc_set0.UserUniforms).Tweak_N12;
Output_N12=param_2;
float Output_N13=0.0;
Output_N13=Output_N12+(*sc_set0.UserUniforms).Port_Input1_N013;
float4 Value_N10=float4(0.0);
float param_3=Output_N11;
float4 param_4=(*sc_set0.UserUniforms).Port_Value0_N010;
float param_5=(*sc_set0.UserUniforms).Port_Position1_N010;
float4 param_6=(*sc_set0.UserUniforms).Port_Value1_N010;
float param_7=Output_N12;
float4 param_8=(*sc_set0.UserUniforms).Port_Value2_N010;
float param_9=Output_N13;
float4 param_10=(*sc_set0.UserUniforms).Port_Value3_N010;
float4 param_11=(*sc_set0.UserUniforms).Port_Value4_N010;
param_3=fast::clamp(param_3,0.0,1.0);
float4 param_12;
if (param_3<param_5)
{
param_12=mix(param_4,param_6,float4(fast::clamp(param_3/param_5,0.0,1.0)));
}
else
{
if (param_3<param_7)
{
param_12=mix(param_6,param_8,float4(fast::clamp((param_3-param_5)/(param_7-param_5),0.0,1.0)));
}
else
{
if (param_3<param_9)
{
param_12=mix(param_8,param_10,float4(fast::clamp((param_3-param_7)/(param_9-param_7),0.0,1.0)));
}
else
{
param_12=mix(param_10,param_11,float4(fast::clamp((param_3-param_9)/(1.0-param_9),0.0,1.0)));
}
}
}
...
if (l9_2)
{
l9_3=10==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_3=l9_2;
...
PreviewInfo.Color=param_12;
}
Value_N10=param_12;
float Output_N17=0.0;
float param_13=(*sc_set0.UserUniforms).GlobalOpacity;
Output_N17=param_13;
float4 Output_N16=float4(0.0);
Output_N16=Value_N10*float4(Output_N17);
float4 Value_N0=float4(0.0);
float param_14=Output_N11;
float4 param_15=(*sc_set0.UserUniforms).Port_Value0_N000;
float param_16=(*sc_set0.UserUniforms).Port_Position1_N000;
float4 param_17=(*sc_set0.UserUniforms).Port_Value1_N000;
float param_18=(*sc_set0.UserUniforms).Port_Position2_N000;
float4 param_19=(*sc_set0.UserUniforms).Port_Value2_N000;
float param_20=(*sc_set0.UserUniforms).Port_Position3_N000;
float4 param_21=(*sc_set0.UserUniforms).Port_Value3_N000;
float4 param_22=(*sc_set0.UserUniforms).Port_Value4_N000;
param_14=fast::clamp(param_14,0.0,1.0);
float4 param_23;
if (param_14<param_16)
{
param_23=mix(param_15,param_17,float4(fast::clamp(param_14/param_16,0.0,1.0)));
}
else
{
if (param_14<param_18)
{
param_23=mix(param_17,param_19,float4(fast::clamp((param_14-param_16)/(param_18-param_16),0.0,1.0)));
}
else
{
if (param_14<param_20)
{
param_23=mix(param_19,param_21,float4(fast::clamp((param_14-param_18)/(param_20-param_18),0.0,1.0)));
}
else
{
param_23=mix(param_21,param_22,float4(fast::clamp((param_14-param_20)/(1.0-param_20),0.0,1.0)));
}
}
}
bool l9_4=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_5;
if (l9_4)
{
l9_5=!PreviewInfo.Saved;
}
else
{
l9_5=l9_4;
...
if (l9_5)
{
l9_6=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_6=l9_5;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=param_23;
}
Value_N0=param_23;
float4 Output_N1=float4(0.0);
Output_N1=Value_N0*float4((*sc_set0.UserUniforms).Port_Input1_N001);
float4 Output_N7=float4(0.0);
Output_N7=Output_N1*float4(Output_N17);
float4 Output_N5=float4(0.0);
Output_N5=Output_N16+Output_N7;
float4 Output_N3=float4(0.0);
Output_N3=fast::clamp(Output_N5+float4(0.001),(*sc_set0.UserUniforms).Port_Input1_N003+float4(0.001),(*sc_set0.UserUniforms).Port_Input2_N003+float4(0.001))-float4(0.001);
float4 Value_N14=float4(0.0);
Value_N14=float4(Output_N15.xyz.x,Output_N15.xyz.y,Output_N15.xyz.z,Value_N14.w);
Value_N14.w=Output_N3.x;
...
float4 l9_10=fast::max(param_25,float4(0.0));
float4 param_26=l9_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
