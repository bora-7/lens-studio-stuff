...
//}
//ubo int UserUniforms 0:33:4816 {
//float4 sc_Time 1376
...
//float4 Tweak_N6 4512
//float Tweak_N3 4528
//float4 Port_Input0_N102 4544
//float Port_Import_N092 4576
//float4 Port_Input1_N094 4592
//float Port_Import_N095 4608
//float Port_Import_N100 4612
//float Port_RangeMinA_N079 4616
//float Port_RangeMaxA_N079 4620
//float Port_RangeMinB_N079 4624
//float Port_RangeMaxB_N079 4628
//float4 Port_Value0_N080 4640
//float Port_Position1_N080 4656
//float4 Port_Value1_N080 4672
//float Port_Position2_N080 4688
//float4 Port_Value2_N080 4704
//float Port_Position3_N080 4720
//float4 Port_Value3_N080 4736
//float Port_Position4_N080 4752
//float4 Port_Value4_N080 4768
//float4 Port_Value5_N080 4784
//float Port_Input1_N081 4800
//float depthRef 4804
//}
...
float4 param_12=(*sc_set0.UserUniforms).Tweak_N6;
Output_N6=param_12;
float4 Output_N7=float4(0.0);
Output_N7=Export_N113*Output_N6;
float Value1_N1=0.0;
float Value2_N1=0.0;
float Value3_N1=0.0;
float4 param_13=Output_N7;
float param_14=param_13.x;
float param_15=param_13.y;
float param_16=param_13.z;
Value1_N1=param_14;
Value2_N1=param_15;
Value3_N1=param_16;
float Output_N3=0.0;
float param_17=(*sc_set0.UserUniforms).Tweak_N3;
Output_N3=param_17;
float4 Value_N2=float4(0.0);
Value_N2.x=Value1_N1;
Value_N2.y=Value2_N1;
Value_N2.z=Value3_N1;
Value_N2.w=Output_N3;
...
float param_18=ValueOut_N79;
float4 param_19=(*sc_set0.UserUniforms).Port_Value0_N080;
float param_20=(*sc_set0.UserUniforms).Port_Position1_N080;
float4 param_21=(*sc_set0.UserUniforms).Port_Value1_N080;
float param_22=(*sc_set0.UserUniforms).Port_Position2_N080;
float4 param_23=(*sc_set0.UserUniforms).Port_Value2_N080;
float param_24=(*sc_set0.UserUniforms).Port_Position3_N080;
float4 param_25=(*sc_set0.UserUniforms).Port_Value3_N080;
float param_26=(*sc_set0.UserUniforms).Port_Position4_N080;
float4 param_27=(*sc_set0.UserUniforms).Port_Value4_N080;
float4 param_28=(*sc_set0.UserUniforms).Port_Value5_N080;
param_18=fast::clamp(param_18,0.0,1.0);
float4 param_29;
if (param_18<param_20)
{
param_29=mix(param_19,param_21,float4(fast::clamp(param_18/param_20,0.0,1.0)));
}
else
{
if (param_18<param_22)
{
param_29=mix(param_21,param_23,float4(fast::clamp((param_18-param_20)/(param_22-param_20),0.0,1.0)));
}
else
{
if (param_18<param_24)
{
param_29=mix(param_23,param_25,float4(fast::clamp((param_18-param_22)/(param_24-param_22),0.0,1.0)));
}
else
{
if (param_18<param_26)
{
param_29=mix(param_25,param_27,float4(fast::clamp((param_18-param_24)/(param_26-param_24),0.0,1.0)));
}
else
{
param_29=mix(param_27,param_28,float4(fast::clamp((param_18-param_26)/(1.0-param_26),0.0,1.0)));
}
}
}
}
bool l9_76=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_77;
if (l9_76)
{
l9_77=!PreviewInfo.Saved;
}
else
{
l9_77=l9_76;
...
if (l9_77)
{
l9_78=80==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_78=l9_77;
...
{
l9_79=pow(Value_N80.x,(*sc_set0.UserUniforms).Port_Input1_N081);
}
float l9_80=l9_79;
float l9_81;
if (Value_N80.y<=0.0)
...
{
l9_81=pow(Value_N80.y,(*sc_set0.UserUniforms).Port_Input1_N081);
}
float l9_82=l9_81;
float l9_83;
if (Value_N80.z<=0.0)
...
{
l9_83=pow(Value_N80.z,(*sc_set0.UserUniforms).Port_Input1_N081);
}
float l9_84=l9_83;
float l9_85;
if (Value_N80.w<=0.0)
...
{
l9_85=pow(Value_N80.w,(*sc_set0.UserUniforms).Port_Input1_N081);
}
Output_N81=float4(l9_80,l9_82,l9_84,l9_85);
float4 Output_N82=float4(0.0);
Output_N82=Value_N2*Output_N81;
...
int l9_124=l9_119;
float2 l9_125=l9_117;
int l9_126=sc_ScreenTextureLayout_tmp;
int l9_127=l9_124;
float l9_128=l9_118;
...
float4 l9_135=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_134.xy,bias(l9_128));
float4 l9_136=l9_135;
float4 l9_137=l9_136;
l9_100=l9_137;
}
float4 l9_138=l9_100;
float3 l9_139=l9_138.xyz;
float3 l9_140=l9_139;
float3 l9_141=l9_98.xyz;
float3 l9_142=definedBlend(l9_140,l9_141,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_99=float4(l9_142.x,l9_142.y,l9_142.z,l9_99.w);
float3 l9_143=mix(l9_139,l9_99.xyz,float3(l9_98.w));
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_145=float4(in.varScreenPos.xyz,1.0);
param_33=l9_145;
}
else
{
...
float l9_147=fast::clamp(abs(l9_146.z),0.0,1.0);
float4 l9_148=float4(l9_147,1.0-l9_147,1.0,1.0);
param_33=l9_148;
}
else
{
float4 l9_149=param_33;
