...
//sampler sampler Tweak_N8SmpSC 0:22
...
//texture texture2D Tweak_N8 0:4:0:22
...
//}
//ubo int UserUniforms 0:33:4640 {
//float4 sc_Time 1376
...
//float4 Tweak_N18 4384
//float3x3 Tweak_N8Transform 4448
//float4 Tweak_N8UvMinMax 4496
//float4 Tweak_N8BorderColor 4512
//float Tweak_N182 4528
//float Tweak_N11 4532
//float Tweak_N21 4536
//float Port_Input1_N006 4540
//float4 Port_Input0_N020 4544
//float Port_Input1_N027 4560
//float2 Port_Scale_N012 4568
//float2 Port_Center_N012 4576
//float2 Port_Center_N014 4592
//float Port_RangeMinA_N013 4600
//float Port_RangeMaxA_N013 4604
//float Port_RangeMinB_N013 4608
//float Port_RangeMaxB_N013 4612
//float Port_Value2_N010 4616
//float2 Port_Center_N157 4624
//float Port_Input1_N024 4632
//float depthRef 4636
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N8 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N8 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N8 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N8HasSwappedViews 37 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N8 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N8 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int Tweak_N8Layout 75 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N8 [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N8 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N8 [[function_constant(35)]];
...
constant bool Tweak_N8HasSwappedViews [[function_constant(37)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N8 [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N8 [[function_constant(73)]];
...
constant int Tweak_N8Layout [[function_constant(75)]];
...
float4 param_1=(*sc_set0.UserUniforms).Tweak_N18;
Output_N18=param_1;
float2 UVCoord_N0=float2(0.0);
UVCoord_N0=Globals.Surface_UVCoord0;
float Output_N5=0.0;
Output_N5=UVCoord_N0.x;
float Output_N6=0.0;
Output_N6=float(Output_N5<(*sc_set0.UserUniforms).Port_Input1_N006);
float4 Output_N19=float4(0.0);
Output_N19=mix(Output_N18,Output_N18,float4(Output_N6));
float Output_N27=0.0;
Output_N27=Output_N6*(*sc_set0.UserUniforms).Port_Input1_N027;
float Output_N28=0.0;
Output_N28=Output_N18.w;
float Output_N25=0.0;
Output_N25=Output_N27+Output_N28;
float2 CoordsOut_N12=float2(0.0);
CoordsOut_N12=((UVCoord_N0-(*sc_set0.UserUniforms).Port_Center_N012)*(*sc_set0.UserUniforms).Port_Scale_N012)+(*sc_set0.UserUniforms).Port_Center_N012;
float4x4 Matrix_N184=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
Matrix_N184=(*sc_set0.UserUniforms).sc_ModelMatrix;
float4 Vector0_N185=float4(0.0);
float4 Vector1_N185=float4(0.0);
float4x4 param_2=Matrix_N184;
float4 param_3=param_2[0];
float4 param_4=param_2[1];
Vector0_N185=param_3;
Vector1_N185=param_4;
float3 Output_N186=float3(0.0);
Output_N186=float3(Vector0_N185.x,Vector0_N185.y,Vector0_N185.z);
float Output_N187=0.0;
Output_N187=length(Output_N186);
float Output_N182=0.0;
float param_5=(*sc_set0.UserUniforms).Tweak_N182;
Output_N182=param_5;
float Value_N189=0.0;
Value_N189=Output_N182;
float Output_N190=0.0;
Output_N190=Output_N187*Value_N189;
float4 Result_N194=float4(0.0);
float param_6=0.0;
float4 param_7=float4(0.0);
float4 param_8=float4(0.0);
float4x4 l9_1=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
l9_1=(*sc_set0.UserUniforms).sc_ModelMatrix;
...
l9_7=float3(l9_2.x,l9_2.y,l9_2.z);
float l9_8=0.0;
l9_8=length(l9_7);
float3 l9_9=float3(0.0);
l9_9=float3(l9_3.x,l9_3.y,l9_3.z);
float l9_10=0.0;
l9_10=length(l9_9);
float l9_11=0.0;
l9_11=float(l9_8<l9_10);
param_6=l9_11;
float4 param_9;
if ((param_6*1.0)!=0.0)
{
float4x4 l9_12=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
l9_12=(*sc_set0.UserUniforms).sc_ModelMatrix;
float4 l9_13=float4(0.0);
float4x4 l9_14=l9_12;
float4 l9_15=l9_14[0];
l9_13=l9_15;
float3 l9_16=float3(0.0);
l9_16=float3(l9_13.x,l9_13.y,l9_13.z);
float l9_17=0.0;
l9_17=length(l9_16);
param_7=float4(l9_17);
param_9=param_7;
}
else
{
float4x4 l9_18=float4x4(float4(0.0),float4(0.0),float4(0.0),float4(0.0));
l9_18=(*sc_set0.UserUniforms).sc_ModelMatrix;
float4 l9_19=float4(0.0);
float4x4 l9_20=l9_18;
float4 l9_21=l9_20[1];
l9_19=l9_21;
float3 l9_22=float3(0.0);
l9_22=float3(l9_19.x,l9_19.y,l9_19.z);
float l9_23=0.0;
l9_23=length(l9_22);
param_8=float4(l9_23);
param_9=param_8;
}
Result_N194=param_9;
float4 Output_N196=float4(0.0);
Output_N196=float4(Output_N190)/(Result_N194+float4(1.234e-06));
float3 Output_N191=float3(0.0);
Output_N191=float3(Vector1_N185.x,Vector1_N185.y,Vector1_N185.z);
float Output_N192=0.0;
Output_N192=length(Output_N191);
float Output_N198=0.0;
Output_N198=Value_N189*Output_N192;
float4 Output_N200=float4(0.0);
Output_N200=float4(Output_N198)/(Result_N194+float4(1.234e-06));
float2 Value_N201=float2(0.0);
Value_N201.x=Output_N196.x;
Value_N201.y=Output_N200.x;
float2 Export_N202=float2(0.0);
Export_N202=Value_N201;
float2 CoordsOut_N14=float2(0.0);
CoordsOut_N14=((CoordsOut_N12-(*sc_set0.UserUniforms).Port_Center_N014)*Export_N202)+(*sc_set0.UserUniforms).Port_Center_N014;
float Output_N11=0.0;
float param_10=(*sc_set0.UserUniforms).Tweak_N11;
Output_N11=param_10;
float ValueOut_N13=0.0;
ValueOut_N13=(((Output_N11-(*sc_set0.UserUniforms).Port_RangeMinA_N013)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N013-(*sc_set0.UserUniforms).Port_RangeMinA_N013)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N013-(*sc_set0.UserUniforms).Port_RangeMinB_N013))+(*sc_set0.UserUniforms).Port_RangeMinB_N013;
float2 Value_N10=float2(0.0);
Value_N10.x=ValueOut_N13;
Value_N10.y=(*sc_set0.UserUniforms).Port_Value2_N010;
float2 CoordsOut_N2=float2(0.0);
CoordsOut_N2=CoordsOut_N14+Value_N10;
...
int l9_29=l9_24;
int param_11=Tweak_N8Layout_tmp;
int param_12=l9_29;
float2 param_13=CoordsOut_N2;
bool param_14=(int(SC_USE_UV_TRANSFORM_Tweak_N8_tmp)!=0);
float3x3 param_15=(*sc_set0.UserUniforms).Tweak_N8Transform;
int2 param_16=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8_tmp);
bool param_17=(int(SC_USE_UV_MIN_MAX_Tweak_N8_tmp)!=0);
float4 param_18=(*sc_set0.UserUniforms).Tweak_N8UvMinMax;
bool param_19=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8_tmp)!=0);
float4 param_20=(*sc_set0.UserUniforms).Tweak_N8BorderColor;
float param_21=0.0;
bool l9_30=param_19&&(!param_17);
float l9_31=1.0;
float l9_32=param_13.x;
int l9_33=param_16.x;
if (l9_33==1)
{
l9_32=fract(l9_32);
}
...
float l9_44=param_13.x;
float l9_45=param_18.x;
float l9_46=param_18.z;
bool l9_47=l9_43;
float l9_48=l9_31;
...
float l9_53=param_13.y;
float l9_54=param_18.y;
float l9_55=param_18.w;
bool l9_56=l9_52;
float l9_57=l9_31;
...
float2 l9_60=param_13;
bool l9_61=param_14;
float3x3 l9_62=param_15;
if (l9_61)
{
...
float2 l9_63=l9_60;
param_13=l9_63;
float l9_64=param_13.x;
int l9_65=param_16.x;
bool l9_66=l9_30;
float l9_67=l9_31;
if ((l9_65==0)||(l9_65==3))
{
...
param_13.x=l9_64;
l9_31=l9_67;
float l9_75=param_13.y;
int l9_76=param_16.y;
bool l9_77=l9_30;
float l9_78=l9_31;
if ((l9_76==0)||(l9_76==3))
{
...
param_13.y=l9_75;
l9_31=l9_78;
float2 l9_86=param_13;
int l9_87=param_11;
int l9_88=param_12;
float l9_89=param_21;
float2 l9_90=l9_86;
int l9_91=l9_87;
int l9_92=l9_88;
...
float3 l9_94=l9_93;
float3 l9_95=l9_94;
float4 l9_96=sc_set0.Tweak_N8.sample(sc_set0.Tweak_N8SmpSC,l9_95.xy,bias(l9_89));
float4 l9_97=l9_96;
if (param_19)
{
l9_97=mix(param_20,l9_97,float4(l9_31));
}
float4 l9_98=l9_97;
Color_N16=l9_98;
float2 CoordsOut_N157=float2(0.0);
CoordsOut_N157=((UVCoord_N0-(*sc_set0.UserUniforms).Port_Center_N157)*Export_N202)+(*sc_set0.UserUniforms).Port_Center_N157;
float2 CoordsOut_N1=float2(0.0);
CoordsOut_N1=CoordsOut_N157+Value_N10;
...
int l9_104=l9_99;
int param_22=Tweak_N8Layout_tmp;
int param_23=l9_104;
float2 param_24=CoordsOut_N1;
bool param_25=(int(SC_USE_UV_TRANSFORM_Tweak_N8_tmp)!=0);
float3x3 param_26=(*sc_set0.UserUniforms).Tweak_N8Transform;
int2 param_27=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8_tmp);
bool param_28=(int(SC_USE_UV_MIN_MAX_Tweak_N8_tmp)!=0);
float4 param_29=(*sc_set0.UserUniforms).Tweak_N8UvMinMax;
bool param_30=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8_tmp)!=0);
float4 param_31=(*sc_set0.UserUniforms).Tweak_N8BorderColor;
float param_32=0.0;
bool l9_105=param_30&&(!param_28);
float l9_106=1.0;
float l9_107=param_24.x;
int l9_108=param_27.x;
if (l9_108==1)
{
l9_107=fract(l9_107);
}
...
param_24.x=l9_107;
float l9_112=param_24.y;
int l9_113=param_27.y;
if (l9_113==1)
{
l9_112=fract(l9_112);
}
...
float l9_119=param_24.x;
float l9_120=param_29.x;
float l9_121=param_29.z;
bool l9_122=l9_118;
float l9_123=l9_106;
...
float l9_128=param_24.y;
float l9_129=param_29.y;
float l9_130=param_29.w;
bool l9_131=l9_127;
float l9_132=l9_106;
...
float2 l9_135=param_24;
bool l9_136=param_25;
float3x3 l9_137=param_26;
if (l9_136)
{
...
param_24=l9_138;
float l9_139=param_24.x;
int l9_140=param_27.x;
bool l9_141=l9_105;
float l9_142=l9_106;
...
param_24.x=l9_139;
l9_106=l9_142;
float l9_150=param_24.y;
int l9_151=param_27.y;
bool l9_152=l9_105;
float l9_153=l9_106;
...
param_24.y=l9_150;
l9_106=l9_153;
float2 l9_161=param_24;
int l9_162=param_22;
int l9_163=param_23;
float l9_164=param_32;
...
float4 l9_171=sc_set0.Tweak_N8.sample(sc_set0.Tweak_N8SmpSC,l9_170.xy,bias(l9_164));
float4 l9_172=l9_171;
if (param_30)
{
l9_172=mix(param_31,l9_172,float4(l9_106));
}
float4 l9_173=l9_172;
Color_N9=l9_173;
float4 Output_N17=float4(0.0);
Output_N17=fast::min(Color_N16,Color_N9);
float4 Output_N20=float4(0.0);
Output_N20=mix((*sc_set0.UserUniforms).Port_Input0_N020,float4(Output_N25),Output_N17);
float Output_N24=0.0;
Output_N24=float(Output_N20.x<(*sc_set0.UserUniforms).Port_Input1_N024);
float4 Output_N23=float4(0.0);
float4 param_33=Output_N20;
float param_34=Output_N24;
float4 param_35=param_33;
if ((param_34*1.0)!=0.0)
{
discard_fragment();
}
...
float param_36=(*sc_set0.UserUniforms).Tweak_N21;
Output_N21=param_36;
float4 Output_N29=float4(0.0);
Output_N29=Output_N23*float4(Output_N21);
float4 Value_N3=float4(0.0);
Value_N3=float4(Output_N19.xyz.x,Output_N19.xyz.y,Output_N19.xyz.z,Value_N3.w);
Value_N3.w=Output_N29.x;
FinalColor=Value_N3;
float param_37=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_37<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_175=floor(mod(l9_174.xy,float2(4.0)));
float l9_176=(mod(dot(l9_175,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_37<l9_176)
{
discard_fragment();
}
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_41,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_42=FinalColor;
float4 l9_244=param_42;
if (sc_ShaderCacheConstant_tmp!=0)
{
