...
//sampler sampler iconMapSmpSC 0:24
...
//texture texture2D iconMap 0:5:0:24
...
//float4 strokeColor 4384
//float4 selectedColor 4400
//float hover 4416
//float3x3 baseTexTransform 4480
//float4 baseTexUvMinMax 4528
//float4 baseTexBorderColor 4544
//float4 iconColor 4560
//float3x3 iconMapTransform 4624
//float4 iconMapUvMinMax 4672
//float4 iconMapBorderColor 4688
//float globalOpacity 4704
//float Port_RangeMinA_N023 4708
//float Port_RangeMaxA_N023 4712
//float Port_RangeMinB_N023 4716
//float Port_RangeMaxB_N023 4720
//float Port_RangeMinA_N016 4724
//float Port_RangeMaxA_N016 4728
//float Port_RangeMinB_N016 4732
//float Port_RangeMaxB_N016 4736
//float2 Port_Center_N014 4744
//float Port_RangeMinA_N017 4752
//float Port_RangeMaxA_N017 4756
//float Port_RangeMinB_N017 4760
//float Port_RangeMaxB_N017 4764
//float Port_Input1_N013 4800
//float Port_Input2_N013 4804
//float depthRef 4808
//}
...
//spec_const bool iconMapHasSwappedViews 42 0
...
constant bool SC_USE_CLAMP_TO_BORDER_iconMap [[function_constant(32)]];
constant bool SC_USE_CLAMP_TO_BORDER_iconMap_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_iconMap) ? SC_USE_CLAMP_TO_BORDER_iconMap : false;
...
constant bool SC_USE_UV_MIN_MAX_iconMap [[function_constant(35)]];
constant bool SC_USE_UV_MIN_MAX_iconMap_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_iconMap) ? SC_USE_UV_MIN_MAX_iconMap : false;
...
constant bool SC_USE_UV_TRANSFORM_iconMap [[function_constant(38)]];
constant bool SC_USE_UV_TRANSFORM_iconMap_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_iconMap) ? SC_USE_UV_TRANSFORM_iconMap : false;
...
constant bool iconMapHasSwappedViews [[function_constant(42)]];
constant bool iconMapHasSwappedViews_tmp = is_function_constant_defined(iconMapHasSwappedViews) ? iconMapHasSwappedViews : false;
...
constant int SC_SOFTWARE_WRAP_MODE_U_iconMap [[function_constant(76)]];
constant int SC_SOFTWARE_WRAP_MODE_U_iconMap_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_iconMap) ? SC_SOFTWARE_WRAP_MODE_U_iconMap : -1;
...
constant int SC_SOFTWARE_WRAP_MODE_V_iconMap [[function_constant(79)]];
constant int SC_SOFTWARE_WRAP_MODE_V_iconMap_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_iconMap) ? SC_SOFTWARE_WRAP_MODE_V_iconMap : -1;
...
constant int iconMapLayout [[function_constant(82)]];
constant int iconMapLayout_tmp = is_function_constant_defined(iconMapLayout) ? iconMapLayout : 0;
...
float4 iconMapDims;
float4 iconMapView;
float3x3 iconMapTransform;
float4 iconMapUvMinMax;
float4 iconMapBorderColor;
float globalOpacity;
float Port_RangeMinA_N023;
float Port_RangeMaxA_N023;
float Port_RangeMinB_N023;
float Port_RangeMaxB_N023;
float Port_RangeMinA_N016;
float Port_RangeMaxA_N016;
float Port_RangeMinB_N016;
float Port_RangeMaxB_N016;
...
float4 param_1=(*sc_set0.UserUniforms).strokeColor;
Output_N1=param_1;
float4 Output_N10=float4(0.0);
float4 param_2=(*sc_set0.UserUniforms).selectedColor;
Output_N10=param_2;
float Output_N15=0.0;
float param_3=(*sc_set0.UserUniforms).hover;
Output_N15=param_3;
float ValueOut_N23=0.0;
float param_4=Output_N15;
float param_6=(*sc_set0.UserUniforms).Port_RangeMinA_N023;
float param_7=(*sc_set0.UserUniforms).Port_RangeMaxA_N023;
float param_8=(*sc_set0.UserUniforms).Port_RangeMinB_N023;
float param_9=(*sc_set0.UserUniforms).Port_RangeMaxB_N023;
float param_5=(((param_4-param_6)/((param_7-param_6)+1e-06))*(param_9-param_8))+param_8;
float l9_1;
if (param_9>param_8)
{
l9_1=fast::clamp(param_5,param_8,param_9);
}
else
{
l9_1=fast::clamp(param_5,param_9,param_8);
}
param_5=l9_1;
ValueOut_N23=param_5;
float4 Output_N11=float4(0.0);
Output_N11=mix(Output_N1,Output_N10,float4(ValueOut_N23));
float2 UVCoord_N12=float2(0.0);
UVCoord_N12=Globals.Surface_UVCoord0;
float ValueOut_N16=0.0;
float param_10=Output_N15;
float param_12=(*sc_set0.UserUniforms).Port_RangeMinA_N016;
float param_13=(*sc_set0.UserUniforms).Port_RangeMaxA_N016;
float param_14=(*sc_set0.UserUniforms).Port_RangeMinB_N016;
float param_15=(*sc_set0.UserUniforms).Port_RangeMaxB_N016;
float param_11=(((param_10-param_12)/((param_13-param_12)+1e-06))*(param_15-param_14))+param_14;
float l9_2;
if (param_15>param_14)
{
l9_2=fast::clamp(param_11,param_14,param_15);
}
else
{
l9_2=fast::clamp(param_11,param_15,param_14);
}
param_11=l9_2;
ValueOut_N16=param_11;
float2 CoordsOut_N14=float2(0.0);
CoordsOut_N14=((UVCoord_N12-(*sc_set0.UserUniforms).Port_Center_N014)*float2(ValueOut_N16))+(*sc_set0.UserUniforms).Port_Center_N014;
...
int l9_8=l9_3;
int param_16=baseTexLayout_tmp;
int param_17=l9_8;
float2 param_18=CoordsOut_N14;
bool param_19=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 param_20=(*sc_set0.UserUniforms).baseTexTransform;
int2 param_21=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool param_22=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool param_24=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 param_25=(*sc_set0.UserUniforms).baseTexBorderColor;
float param_26=0.0;
bool l9_9=param_24&&(!param_22);
float l9_10=1.0;
float l9_11=param_18.x;
int l9_12=param_21.x;
if (l9_12==1)
{
l9_11=fract(l9_11);
}
...
param_18.x=l9_11;
float l9_16=param_18.y;
int l9_17=param_21.y;
if (l9_17==1)
{
l9_16=fract(l9_16);
}
...
float l9_23=param_18.x;
float l9_24=param_23.x;
float l9_25=param_23.z;
bool l9_26=l9_22;
float l9_27=l9_10;
...
float l9_32=param_18.y;
float l9_33=param_23.y;
float l9_34=param_23.w;
bool l9_35=l9_31;
float l9_36=l9_10;
...
float2 l9_39=param_18;
bool l9_40=param_19;
float3x3 l9_41=param_20;
if (l9_40)
{
...
float2 l9_42=l9_39;
param_18=l9_42;
float l9_43=param_18.x;
int l9_44=param_21.x;
bool l9_45=l9_9;
float l9_46=l9_10;
if ((l9_44==0)||(l9_44==3))
{
...
param_18.x=l9_43;
l9_10=l9_46;
float l9_54=param_18.y;
int l9_55=param_21.y;
bool l9_56=l9_9;
float l9_57=l9_10;
if ((l9_55==0)||(l9_55==3))
{
...
param_18.y=l9_54;
l9_10=l9_57;
float2 l9_65=param_18;
int l9_66=param_16;
int l9_67=param_17;
float l9_68=param_26;
float2 l9_69=l9_65;
int l9_70=l9_66;
int l9_71=l9_67;
...
float3 l9_73=l9_72;
float3 l9_74=l9_73;
float4 l9_75=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_74.xy,bias(l9_68));
float4 l9_76=l9_75;
if (param_24)
{
l9_76=mix(param_25,l9_76,float4(l9_10));
}
float4 l9_77=l9_76;
Output_N0=l9_77;
float Output_N3=0.0;
Output_N3=Output_N0.x;
float ValueOut_N17=0.0;
float param_27=Output_N15;
float param_29=(*sc_set0.UserUniforms).Port_RangeMinA_N017;
float param_30=(*sc_set0.UserUniforms).Port_RangeMaxA_N017;
float param_31=(*sc_set0.UserUniforms).Port_RangeMinB_N017;
float param_32=(*sc_set0.UserUniforms).Port_RangeMaxB_N017;
float param_28=(((param_27-param_29)/((param_30-param_29)+1e-06))*(param_32-param_31))+param_31;
float l9_78;
if (param_32>param_31)
{
l9_78=fast::clamp(param_28,param_31,param_32);
}
else
{
l9_78=fast::clamp(param_28,param_32,param_31);
}
param_28=l9_78;
ValueOut_N17=param_28;
float Output_N18=0.0;
Output_N18=Output_N3*ValueOut_N17;
float4 Value_N5=float4(0.0);
Value_N5=float4(Output_N11.xyz.x,Output_N11.xyz.y,Output_N11.xyz.z,Value_N5.w);
Value_N5.w=Output_N18;
float4 Value_N73=float4(0.0);
Value_N73=Value_N5;
float4 Output_N2=float4(0.0);
float4 param_33=(*sc_set0.UserUniforms).iconColor;
Output_N2=param_33;
float4 Output_N9=float4(0.0);
int l9_79;
if ((int(iconMapHasSwappedViews_tmp)!=0))
{
int l9_80=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_84=l9_79;
int param_34=iconMapLayout_tmp;
int param_35=l9_84;
float2 param_36=CoordsOut_N14;
bool param_37=(int(SC_USE_UV_TRANSFORM_iconMap_tmp)!=0);
float3x3 param_38=(*sc_set0.UserUniforms).iconMapTransform;
int2 param_39=int2(SC_SOFTWARE_WRAP_MODE_U_iconMap_tmp,SC_SOFTWARE_WRAP_MODE_V_iconMap_tmp);
bool param_40=(int(SC_USE_UV_MIN_MAX_iconMap_tmp)!=0);
float4 param_41=(*sc_set0.UserUniforms).iconMapUvMinMax;
bool param_42=(int(SC_USE_CLAMP_TO_BORDER_iconMap_tmp)!=0);
float4 param_43=(*sc_set0.UserUniforms).iconMapBorderColor;
float param_44=0.0;
bool l9_85=param_42&&(!param_40);
float l9_86=1.0;
float l9_87=param_36.x;
int l9_88=param_39.x;
if (l9_88==1)
{
l9_87=fract(l9_87);
}
...
param_36.x=l9_87;
float l9_92=param_36.y;
int l9_93=param_39.y;
if (l9_93==1)
{
l9_92=fract(l9_92);
}
...
float l9_99=param_36.x;
float l9_100=param_41.x;
float l9_101=param_41.z;
bool l9_102=l9_98;
float l9_103=l9_86;
...
float l9_108=param_36.y;
float l9_109=param_41.y;
float l9_110=param_41.w;
bool l9_111=l9_107;
float l9_112=l9_86;
...
float2 l9_115=param_36;
bool l9_116=param_37;
float3x3 l9_117=param_38;
if (l9_116)
{
...
param_36=l9_118;
float l9_119=param_36.x;
int l9_120=param_39.x;
bool l9_121=l9_85;
float l9_122=l9_86;
...
param_36.x=l9_119;
l9_86=l9_122;
float l9_130=param_36.y;
int l9_131=param_39.y;
bool l9_132=l9_85;
float l9_133=l9_86;
...
param_36.y=l9_130;
l9_86=l9_133;
float2 l9_141=param_36;
int l9_142=param_34;
int l9_143=param_35;
float l9_144=param_44;
...
float4 l9_151=sc_set0.iconMap.sample(sc_set0.iconMapSmpSC,l9_150.xy,bias(l9_144));
float4 l9_152=l9_151;
if (param_42)
{
l9_152=mix(param_43,l9_152,float4(l9_86));
}
float4 l9_153=l9_152;
Output_N9=l9_153;
float Output_N8=0.0;
Output_N8=Output_N9.x;
float4 Value_N7=float4(0.0);
Value_N7=float4(Output_N2.xyz.x,Output_N2.xyz.y,Output_N2.xyz.z,Value_N7.w);
Value_N7.w=Output_N8;
float4 Value_N76=float4(0.0);
Value_N76=Value_N7;
float Output_N64=0.0;
Output_N64=Value_N76.w;
float3 Output_N62=float3(0.0);
Output_N62=mix(Value_N73.xyz,Value_N76.xyz,float3(Output_N64));
float Output_N63=0.0;
Output_N63=Value_N73.w;
float Output_N65=0.0;
Output_N65=Output_N63+Output_N64;
float Output_N13=0.0;
Output_N13=fast::clamp(Output_N65+0.001,(*sc_set0.UserUniforms).Port_Input1_N013+0.001,(*sc_set0.UserUniforms).Port_Input2_N013+0.001)-0.001;
float4 Value_N69=float4(0.0);
Value_N69=float4(Output_N62.x,Output_N62.y,Output_N62.z,Value_N69.w);
Value_N69.w=Output_N13;
float4 Export_N75=float4(0.0);
Export_N75=Value_N69;
float Output_N19=0.0;
Output_N19=Export_N75.w;
float Output_N20=0.0;
float param_45=(*sc_set0.UserUniforms).globalOpacity;
Output_N20=param_45;
float Output_N21=0.0;
Output_N21=Output_N19*Output_N20;
float4 Value_N22=float4(0.0);
Value_N22=float4(Export_N75.xyz.x,Export_N75.xyz.y,Export_N75.xyz.z,Value_N22.w);
Value_N22.w=Output_N21;
...
float4 l9_157=fast::max(param_47,float4(0.0));
float4 param_48=l9_157;
if (sc_ShaderCacheConstant_tmp!=0)
{
