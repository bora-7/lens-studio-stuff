...
//float3x3 Tweak_N3Transform 4448
//float4 Tweak_N3UvMinMax 4496
//float4 Tweak_N3BorderColor 4512
//float Tweak_N6 4528
//float depthRef 4532
//}
...
int l9_6=l9_1;
int param_2=Tweak_N3Layout_tmp;
int param_3=l9_6;
float2 param_4=Globals.Surface_UVCoord0;
bool param_5=(int(SC_USE_UV_TRANSFORM_Tweak_N3_tmp)!=0);
float3x3 param_6=(*sc_set0.UserUniforms).Tweak_N3Transform;
int2 param_7=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3_tmp);
bool param_8=(int(SC_USE_UV_MIN_MAX_Tweak_N3_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).Tweak_N3UvMinMax;
bool param_10=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).Tweak_N3BorderColor;
float param_12=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.Tweak_N3.sample(sc_set0.Tweak_N3SmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_10)
{
...
Output_N2=Output_N5+Output_N3;
float Output_N6=0.0;
float param_13=(*sc_set0.UserUniforms).Tweak_N6;
Output_N6=param_13;
float4 Value_N1=float4(0.0);
Value_N1=float4(Output_N2.xyz.x,Output_N2.xyz.y,Output_N2.xyz.z,Value_N1.w);
Value_N1.w=Output_N6;
FinalColor=Value_N1;
