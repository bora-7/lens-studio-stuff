...
//sampler sampler Tweak_N12SmpSC 0:22
...
//texture texture2D Tweak_N12 0:4:0:22
...
//float3x3 Tweak_N12Transform 4432
//float4 Tweak_N12UvMinMax 4480
//float4 Tweak_N12BorderColor 4496
//float4 Port_Input0_N102 4512
//float Port_Import_N130 4528
//float3 Port_Import_N132 4544
//float Port_Import_N092 4576
//float4 Port_Input1_N094 4592
//float Port_Import_N095 4608
//float Port_Import_N100 4612
//float3 Port_Normal_N000 4624
//float Port_Exponent_N000 4640
//float Port_Intensity_N000 4644
//float depthRef 4648
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N12 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N12 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N12 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N12HasSwappedViews 37 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N12 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N12 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int Tweak_N12Layout 75 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N12 [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N12 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N12 [[function_constant(35)]];
...
constant bool Tweak_N12HasSwappedViews [[function_constant(37)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N12 [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N12 [[function_constant(73)]];
...
constant int Tweak_N12Layout [[function_constant(75)]];
...
texture2d<float> Tweak_N12 [[id(4)]];
...
{
main_frag_out out={};
int N134_NormalSpace=0;
float3 N134_Normal=float3(0.0);
float2 N134_ReflectionUV=float2(0.0);
...
Value_N130=(*sc_set0.UserUniforms).Port_Import_N130;
float Value_N133=0.0;
Value_N133=1.0;
float3 Value_N132=float3(0.0);
Value_N132=(*sc_set0.UserUniforms).Port_Import_N132;
float2 ReflectionUV_N134=float2(0.0);
float param_1=Value_N133;
float3 param_2=Value_N132;
ssGlobals param_4=Globals;
ssGlobals tempGlobals=param_4;
float2 param_3=float2(0.0);
N134_NormalSpace=int(param_1);
N134_Normal=param_2;
float3 l9_1=N134_Normal;
if (N134_NormalSpace==1)
{
...
l9_1=l9_14*l9_1;
N134_ReflectionUV=(l9_1.xy*0.5)+float2(0.5);
param_3=N134_ReflectionUV;
ReflectionUV_N134=param_3;
float4 Color_N135=float4(0.0);
int l9_15;
...
int l9_20=l9_15;
int param_5=Tweak_N12Layout_tmp;
int param_6=l9_20;
float2 param_7=ReflectionUV_N134;
bool param_8=(int(SC_USE_UV_TRANSFORM_Tweak_N12_tmp)!=0);
float3x3 param_9=(*sc_set0.UserUniforms).Tweak_N12Transform;
int2 param_10=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N12_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N12_tmp);
bool param_11=(int(SC_USE_UV_MIN_MAX_Tweak_N12_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).Tweak_N12UvMinMax;
bool param_13=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N12_tmp)!=0);
float4 param_14=(*sc_set0.UserUniforms).Tweak_N12BorderColor;
float param_15=0.0;
bool l9_21=param_13&&(!param_11);
float l9_22=1.0;
float l9_23=param_7.x;
int l9_24=param_10.x;
if (l9_24==1)
{
l9_23=fract(l9_23);
}
...
param_7.x=l9_23;
float l9_28=param_7.y;
int l9_29=param_10.y;
if (l9_29==1)
{
l9_28=fract(l9_28);
}
...
float l9_36=param_12.x;
float l9_37=param_12.z;
bool l9_38=l9_34;
float l9_39=l9_22;
...
float l9_45=param_12.y;
float l9_46=param_12.w;
bool l9_47=l9_43;
float l9_48=l9_22;
...
float2 l9_51=param_7;
bool l9_52=param_8;
float3x3 l9_53=param_9;
if (l9_52)
{
...
float2 l9_54=l9_51;
param_7=l9_54;
float l9_55=param_7.x;
int l9_56=param_10.x;
bool l9_57=l9_21;
float l9_58=l9_22;
if ((l9_56==0)||(l9_56==3))
{
...
param_7.x=l9_55;
l9_22=l9_58;
float l9_66=param_7.y;
int l9_67=param_10.y;
bool l9_68=l9_21;
float l9_69=l9_22;
if ((l9_67==0)||(l9_67==3))
{
...
param_7.y=l9_66;
l9_22=l9_69;
float2 l9_77=param_7;
int l9_78=param_5;
int l9_79=param_6;
float l9_80=param_15;
float2 l9_81=l9_77;
int l9_82=l9_78;
int l9_83=l9_79;
...
float3 l9_85=l9_84;
float3 l9_86=l9_85;
float4 l9_87=sc_set0.Tweak_N12.sample(sc_set0.Tweak_N12SmpSC,l9_86.xy,bias(l9_80));
float4 l9_88=l9_87;
if (param_13)
{
l9_88=mix(param_14,l9_88,float4(l9_22));
}
float4 l9_89=l9_88;
Color_N135=l9_89;
float4 Output_N136=float4(0.0);
Output_N136=float4(Value_N130)*Color_N135;
float4 Export_N137=float4(0.0);
Export_N137=Output_N136;
float4 Value_N91=float4(0.0);
Value_N91=Export_N137;
float Value_N92=0.0;
...
float Value_N95=0.0;
Value_N95=fast::clamp((*sc_set0.UserUniforms).Port_Import_N095,0.0,2.0);
...
float Rim_N0=0.0;
float3 param_16=(*sc_set0.UserUniforms).Port_Normal_N000;
float param_17=(*sc_set0.UserUniforms).Port_Exponent_N000;
float param_18=(*sc_set0.UserUniforms).Port_Intensity_N000;
ssGlobals param_20=Globals;
param_16=float3x3(float3(param_20.VertexTangent_WorldSpace),float3(param_20.VertexBinormal_WorldSpace),float3(param_20.VertexNormal_WorldSpace))*param_16;
float l9_90=abs(dot(-param_20.ViewDirWS,param_16));
float param_19=pow(1.0-l9_90,param_17);
param_19=fast::max(param_19,0.0);
param_19*=param_18;
Rim_N0=param_19;
float4 Output_N13=float4(0.0);
Output_N13=Export_N113+float4(Rim_N0);
...
float2 l9_92=floor(mod(l9_91.xy,float2(4.0)));
float l9_93=(mod(dot(l9_92,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_21<l9_93)
{
discard_fragment();
}
...
float4 l9_94=fast::max(param_22,float4(0.0));
float4 param_23=l9_94;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
int l9_129=l9_124;
float2 l9_130=l9_122;
int l9_131=sc_ScreenTextureLayout_tmp;
int l9_132=l9_129;
float l9_133=l9_123;
...
float4 l9_140=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_139.xy,bias(l9_133));
float4 l9_141=l9_140;
float4 l9_142=l9_141;
l9_105=l9_142;
}
float4 l9_143=l9_105;
float3 l9_144=l9_143.xyz;
float3 l9_145=l9_144;
float3 l9_146=l9_103.xyz;
float3 l9_147=definedBlend(l9_145,l9_146,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_104=float4(l9_147.x,l9_147.y,l9_147.z,l9_104.w);
float3 l9_148=mix(l9_144,l9_104.xyz,float3(l9_103.w));
l9_104=float4(l9_148.x,l9_148.y,l9_148.z,l9_104.w);
l9_104.w=1.0;
float4 l9_149=l9_104;
param_24=l9_149;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_150=float4(in.varScreenPos.xyz,1.0);
param_24=l9_150;
}
else
{
...
float l9_152=fast::clamp(abs(l9_151.z),0.0,1.0);
float4 l9_153=float4(l9_152,1.0-l9_152,1.0,1.0);
param_24=l9_153;
}
else
{
float4 l9_154=param_24;
