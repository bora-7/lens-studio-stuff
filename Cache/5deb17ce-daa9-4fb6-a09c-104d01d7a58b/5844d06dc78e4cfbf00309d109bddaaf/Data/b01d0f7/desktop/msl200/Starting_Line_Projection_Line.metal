...
FinalColor=sc_OutputMotionVectorIfNeeded(param_22,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_23=FinalColor;
float4 l9_146=param_23;
if (sc_ShaderCacheConstant_tmp!=0)
{
