...
constant bool Tweak_N3 [[function_constant(38)]];
constant bool Tweak_N3_tmp = is_function_constant_defined(Tweak_N3) ? Tweak_N3 : false;
...
float4 param_1=float4(0.29899999,0.58700001,0.114,2.0);
float4 param_2=float4(2.0);
ssGlobals param_4=Globals;
float4 param_3;
if ((int(Tweak_N3_tmp)!=0))
{
...
int l9_7=l9_2;
int l9_8=Tweak_N0Layout_tmp;
int l9_9=l9_7;
float2 l9_10=param_4.Surface_UVCoord0;
bool l9_11=(int(SC_USE_UV_TRANSFORM_Tweak_N0_tmp)!=0);
float3x3 l9_12=(*sc_set0.UserUniforms).Tweak_N0Transform;
int2 l9_13=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0_tmp);
bool l9_14=(int(SC_USE_UV_MIN_MAX_Tweak_N0_tmp)!=0);
float4 l9_15=(*sc_set0.UserUniforms).Tweak_N0UvMinMax;
bool l9_16=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0_tmp)!=0);
float4 l9_17=(*sc_set0.UserUniforms).Tweak_N0BorderColor;
float l9_18=0.0;
...
float3 l9_83=l9_82;
float3 l9_84=l9_83;
float4 l9_85=sc_set0.Tweak_N0.sample(sc_set0.Tweak_N0SmpSC,l9_84.xy,bias(l9_78));
float4 l9_86=l9_85;
if (l9_16)
{
...
l9_97.w=l9_96;
float l9_98=0.0;
float l9_99=(*sc_set0.UserUniforms).Port_Value_N006;
float l9_100=l9_99+0.001;
l9_100-=0.001;
l9_98=l9_100;
float4 l9_101=float4(0.0);
l9_101=l9_97*float4(l9_98);
param_1=l9_101;
param_3=param_1;
}
else
...
int l9_108=l9_103;
int l9_109=Tweak_N0Layout_tmp;
int l9_110=l9_108;
float2 l9_111=param_4.Surface_UVCoord0;
bool l9_112=(int(SC_USE_UV_TRANSFORM_Tweak_N0_tmp)!=0);
float3x3 l9_113=(*sc_set0.UserUniforms).Tweak_N0Transform;
int2 l9_114=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0_tmp);
bool l9_115=(int(SC_USE_UV_MIN_MAX_Tweak_N0_tmp)!=0);
float4 l9_116=(*sc_set0.UserUniforms).Tweak_N0UvMinMax;
bool l9_117=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0_tmp)!=0);
float4 l9_118=(*sc_set0.UserUniforms).Tweak_N0BorderColor;
float l9_119=0.0;
...
float4 l9_186=sc_set0.Tweak_N0.sample(sc_set0.Tweak_N0SmpSC,l9_185.xy,bias(l9_179));
float4 l9_187=l9_186;
if (l9_117)
{
...
float4 l9_192=fast::max(param_6,float4(0.0));
float4 param_7=l9_192;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_204=out.sc_FragData0;
l9_203=l9_204;
}
else
{
...
float4 l9_241=l9_203;
float3 l9_242=l9_241.xyz;
float3 l9_243=l9_242;
float3 l9_244=l9_201.xyz;
...
l9_202=float4(l9_245.x,l9_245.y,l9_245.z,l9_202.w);
float3 l9_246=mix(l9_242,l9_202.xyz,float3(l9_201.w));
l9_202=float4(l9_246.x,l9_246.y,l9_246.z,l9_202.w);
l9_202.w=1.0;
float4 l9_247=l9_202;
param_8=l9_247;
}
else
{
