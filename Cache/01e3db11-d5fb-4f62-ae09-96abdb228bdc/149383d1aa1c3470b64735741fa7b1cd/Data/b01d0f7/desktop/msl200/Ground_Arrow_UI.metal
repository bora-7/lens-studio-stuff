...
//float Tweak_N68 4256
//float4 Tweak_N5 4272
//float3x3 Tweak_N0Transform 4336
//float4 Tweak_N0UvMinMax 4384
//float4 Tweak_N0BorderColor 4400
//float Tweak_N19 4416
//float3 Port_Input0_N066 4432
//float Port_Value_N064 4448
//float Port_Input1_N069 4452
//float Port_RangeMinA_N074 4456
//float Port_RangeMaxA_N074 4460
//float Port_RangeMinB_N074 4464
//float Port_RangeMaxB_N074 4468
//float Port_Input1_N009 4472
//float Port_Input1_N016 4476
//float Port_Input0_N050 4480
//float Port_Input1_N050 4484
//float Port_Import_N086 4488
//float Port_Import_N087 4492
//float Port_Input0_N029 4496
//float Port_Input1_N028 4500
//float Port_Multiplier_N044 4504
//float Port_Input1_N046 4508
//float Port_Input1_N047 4512
//float Port_Input1_N072 4516
//float Port_Import_N032 4524
//float Port_Import_N033 4528
//float Port_Input1_N040 4532
//float Port_Input1_N045 4540
//float Port_Input2_N045 4544
//float2 Port_Input1_N051 4552
//float Port_Input0_N079 4560
//float Port_Input1_N079 4564
//float2 Port_Center_N060 4568
//float Port_Input0_N056 4576
//float Port_Input1_N056 4580
//float Port_Input1_N117 4584
//float2 Port_Center_N053 4592
//float Port_Feather_N078 4600
//float Port_Input0_N023 4604
//float Port_Import_N089 4608
//float Port_Import_N093 4612
//float Port_Input0_N024 4616
//float Port_Input1_N026 4620
//float4 Port_Input0_N082 4624
//float Port_Multiplier_N027 4640
//float Port_Input1_N113 4644
//float Port_Input1_N080 4648
//float Port_Input1_N081 4652
//float Port_Import_N102 4660
//float Port_Import_N103 4664
//float4 Port_Input1_N099 4672
//float Port_Input1_N110 4692
//float Port_Input2_N110 4696
//float Port_Input1_N116 4700
//float Port_Input1_N115 4704
//float Port_Input3_N114 4708
//float4 Port_Input1_N059 4720
//float4 Port_Input2_N059 4736
//}
...
//spec_const bool N78_Out 31 0
//spec_const bool N78_Reevers 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N0 33 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 34 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N0 35 0
...
//spec_const bool Tweak_N0HasSwappedViews 39 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N0 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N0 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 75 -1
//spec_const int Tweak_N0Layout 76 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N0 [[function_constant(72)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N0 [[function_constant(74)]];
...
constant int Tweak_N0Layout [[function_constant(76)]];
...
if (param_9>param_8)
{
l9_122=fast::clamp(param_5,param_8,param_9);
}
else
{
l9_122=fast::clamp(param_5,param_9,param_8);
}
param_5=l9_122;
...
int l9_136=l9_135;
l9_134=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_136]*param_10.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
{
float4 l9_141=param_10.position;
...
float3 param_15=out.varPosAndMotion.xyz;
if ((int(sc_MotionVectorsPass_tmp)!=0))
{
float4 l9_450=((*sc_set0.UserUniforms).sc_PrevFrameModelMatrix*(*sc_set0.UserUniforms).sc_ModelMatrixInverse)*float4(param_15,1.0);
float3 l9_451=param_15;
...
float param_12=0.0;
bool l9_6=param_10&&(!param_8);
float l9_7=1.0;
float l9_8=param_4.x;
int l9_9=param_7.x;
if (l9_9==1)
{
l9_8=fract(l9_8);
...
float l9_29=param_4.y;
float l9_30=param_9.y;
float l9_31=param_9.w;
bool l9_32=l9_28;
float l9_33=l9_7;
...
float2 l9_36=param_4;
bool l9_37=param_5;
float3x3 l9_38=param_6;
if (l9_37)
{
...
param_4.y=l9_51;
l9_7=l9_54;
float2 l9_62=param_4;
int l9_63=param_2;
int l9_64=param_3;
float l9_65=param_12;
float2 l9_66=l9_62;
int l9_67=l9_63;
int l9_68=l9_64;
...
float3 l9_70=l9_69;
float3 l9_71=l9_70;
float4 l9_72=sc_set0.Tweak_N0.sample(sc_set0.Tweak_N0SmpSC,l9_71.xy,bias(l9_65));
float4 l9_73=l9_72;
if (param_10)
{
l9_73=mix(param_11,l9_73,float4(l9_7));
}
float4 l9_74=l9_73;
Color_N1=l9_74;
float Value1_N2=0.0;
...
float l9_75=N78_Gradient;
float l9_76=mix(N78_Progress-N78_Feather,N78_Progress+N78_Feather,N78_Progress);
if ((int(N78_Reevers_tmp)!=0))
{
l9_75=1.0-N78_Gradient;
}
N78_wipe=smoothstep(l9_76-N78_Feather,l9_76+N78_Feather,l9_75);
...
{
l9_77=pow(Output_N110,(*sc_set0.UserUniforms).Port_Input1_N116);
}
Output_N116=l9_77;
